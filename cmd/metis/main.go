...
func cmdRun(args []string) error {
	...
	autoStop := fs.Bool("auto-stop", false, "metis#66: incumbent-referenced early stop of losing families (implies --live). NOT YET ACTIVE at M1 — this flag currently only enables --live fold-ordered scheduling; the ledger-incumbent read + predictive loser-stop + `stopped: auto` marker land in M2.")
